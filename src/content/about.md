...
This 3 minute video goes into some of the benefits of collaboration between libraries and University Presses.
...
The foundation of [Big Ten Open Books](http://bigtenopenbooks.org) is collective action including the partnership between university presses and libraries to develop the program’s model, as well as the multi-press collaboration that populates the content. Our guiding principles and aims are:

* We aspire to develop a programmatic, sustainable approach to our work that mirrors the size and impact of our member institutions. 
* We want to create open-access editions that can be read and reused by anyone, anywhere. 
