...
• Titles are hosted on the open-source Fulcrum platform, developed by the University of Michigan Library.

• Fulcrum aims to meet the latest [WCAG 2 AA standards](https://www.w3.org/WAI/WCAG22/quickref/?versions=2.2) and the platform VPAT® can be downloaded as a PDF from Fulcrum at [fulcrum.org/docs/Fulcrum-VPAT2.5INT-MASTER-20250625.pdf](https://www.fulcrum.org/docs/Fulcrum-VPAT2.5INT-MASTER-20250625.pdf)
